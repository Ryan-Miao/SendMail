...
public class SendMail {
    ...
    public static String myEmailAccount = "123@126.com";
    public static String myEmailPassword = "2222";
    ...
    // 收件人邮箱（替换为自己知道的有效邮箱）
    public static String receiveMailAccount = "123@qq.com";
    ...
    public static void main(String[] args) throws Exception {
        ...
        transport.connect(props.getProperty("mail.host"),myEmailAccount, myEmailPassword);
